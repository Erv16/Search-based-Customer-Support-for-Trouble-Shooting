...
public class ProductThree implements DSeaGateI{
	...
	private ArrayList<String> prodThreeResponses = null;
	String temp ="";
	...
	public ProductThree(){
		...
		MyLogger.writeMessage("Reached constructor of Product Three",DebugLevel.CONSTRUCTOR);
		try{	
			FileProcessor fp = new FileProcessor(System.getProperty("user.dir")+"/src/troubleShootSearch/products/Repository3.txt");
			prodThreeResponses = new ArrayList<String>();
				while((temp = fp.readLine()) != null){
					prodThreeResponses.add(temp);
				} // end of while block
		} // end of try block
		catch(IOException ioe){
			System.err.println("Error: Unable to parse file Repository3.txt");
			ioe.printStackTrace();
			System.exit(1);
		} // end of catch block
	}
	 ...
	 * @param prodThreeResponsesIn the data structure that needs to be set
	 */

	public void setProductContent(ArrayList<String> prodThreeResponsesIn){
		prodThreeResponses = prodThreeResponsesIn;
	}
